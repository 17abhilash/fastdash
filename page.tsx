    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-20">
        ...
        <div className="animate-fade-in-up opacity-0 flex flex-col sm:flex-row gap-4 justify-center mb-12" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
          ...
          <InteractiveButton href="/Abh17ash.pdf" download="Sutar_Abhilash_Resume.pdf" className="btn-white flex items-center justify-center gap-2">
            ...
            <div className="sketchy-card p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Single-handedly covered QA for <span className="font-bold">Darts VR 2: BullsEye</span> across PlayStation VR to Meta VR platforms.</p>
                </div>
              </div>
            </div>
          </div>
